...
const Section_9009b281 = ((
  ...
  // The arrow pair sits as its own row directly above the viewport (above the
  // review/result stack), right-aligned — same placement on mobile and desktop.
