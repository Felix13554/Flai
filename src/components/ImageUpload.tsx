        ...
        {allow360 && (
          ...
          >
            ...
            <div className="flex-1 text-left">
              <span className="font-medium"><EditableContent contentKey="image-upload-360-panorama" fallback="360° Panorama" /></span>
              ...
              {is360 && (
                <p className="text-xs text-primary/80 mt-0.5">
                  <EditableContent contentKey="image-upload-pannellum-viewer-max-8000-4000" fallback="Pannellum viewer · Max 8000×4000 px · JPEG / WebP" />
                </p>
              )}
            </div>
            ...
            {multiUploading && uploadProgress ? (
              <div className="space-y-2">
                <div className="flex items-center justify-center gap-2 text-neutral-300">
                  ...
                  <span className="text-sm"><EditableContent contentKey="image-upload-uploader" fallback="Uploader" /> {uploadProgress.done} / {uploadProgress.total}...</span>
                </div>
